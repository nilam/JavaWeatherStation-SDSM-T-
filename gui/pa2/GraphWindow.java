...
//                        }
            ...
            for (Conditions current : points) {
                if (current.getRain() != Conditions.INVALID_RAIN) {
                    ...
                    switch (timePeriod) {
                        case GraphWindow.DAY:
                            x = c.get(Calendar.HOUR_OF_DAY) * 1000 / 23;
                            x += c.get(Calendar.MINUTE) / 2;
                            break;
                        case GraphWindow.WEEK:
                            x = c.get(Calendar.DAY_OF_WEEK) * 1000 / 6;
                            break;
                        case GraphWindow.MONTH:
                            divisor = c.getActualMaximum(Calendar.DAY_OF_MONTH);
                            x = c.get(Calendar.DAY_OF_MONTH) * 1000 / divisor;
                            break;
                        case GraphWindow.YEAR:
                            x = c.get(Calendar.MONTH) * 1000 / 11;
                            break;
                    }
        ...
        GraphCanvas g1 = new GraphCanvas(map, "Rainfall for " + today, "Inches", timeStrings[timePeriod], divisor + 1);
        ...
        if (points != null) {
            ...
            System.out.println("Initial Pressure x: " + x);
            ...
            for (Conditions current : points) {
                ...
                System.out.println("Ending Pressure x: " + x);
        ...
        GraphCanvas g2 = new GraphCanvas(map, "Barometric Pressure for " + today, "Inches Hg", timeStrings[timePeriod], divisor + 1);
        ...
        GraphCanvas g3 = new GraphCanvas(map, "Temperature for " + today, "Degrees F", timeStrings[timePeriod], divisor + 1);
        ...
        GraphCanvas g4 = new GraphCanvas(map, "Wind Speed for " + today, "MPH", timeStrings[timePeriod], divisor + 1);
        ...
        GraphCanvas g5 = new GraphCanvas(map, "Humidity for " + today, "%", timeStrings[timePeriod], divisor + 1);
        ...
        GraphCanvas g6 = new GraphCanvas(map, "UV Index for " + today, "", timeStrings[timePeriod], divisor + 1);
            ...
            if (canvas.getRelative() != null) {
                ...
                while (it.hasNext() && cont) {
                    ...
                    if (Math.abs(holder.compareTo(pt)) < 5) {
                        System.out.println(Math.abs(holder.compareTo(pt)));
                    }
                    if (Math.abs(holder.compareTo(pt)) < 5) {
                        cont = false;
                    }
